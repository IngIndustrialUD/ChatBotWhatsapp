...
2. Conecta tu repo, elige región, plan Free.
3. Build Command: pip install -r requirements.txt
4. Start Command: gunicorn app:app --workers 2 --threads 4 --timeout 120
5. Agrega en Environment las variables VERIFY_TOKEN y WHATSAPP_TOKEN.
6. Deploy. Copia la URL resultante, por ejemplo: https://tu-servicio.onrender.com.
